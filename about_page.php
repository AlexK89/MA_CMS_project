...
<aside class="sidebar">
    <nav class= "navigation_bar">
        <ul class="tab_list">
            <li class="tab"><a href="main_page.php">Dashboard</a></li>
            <li class="tab"><a href="home_page.php">Edit Home page</a></li>
            <li class="selected_tab"><a href="about_page.php">Edit About page</a></li>
            <li class="tab"><a href="portfolio_page.php">Edit Portfolio page</a></li>
            <li class="tab portfolio_page"><a href="./Portfolio_project-2.0/about.php">Go to Portfolio page</a></li>
        </ul>
    </nav>
</aside>
<div class="content">
    <div class="container">
        <h3 class="form_label">About section</h3>
        <form action="./php_functions/about_functions.php" method="POST" class="main_form about_form">
            <div class="form_block">
                <textarea name="about_welcome_text" id="about_welcome_text" rows="10" placeholder="About me" class="input_area description"><?php echo get_about_data();?></textarea>
            </div>
            <div class="submission_buttons about_form_button">
                <input type="submit" name="update_about" id="update_about" value="UPDATE">
            </div>
        </form>
        <h3 class="form_label">ADD/Modify content form</h3>
        <form action="php_functions/about_functions.php" method="POST" enctype="multipart/form-data" class="main_form">
            <div class="form_block">
        ...
        foreach ($data as $item) {
            ...
            $block_structure .= "<p class=\"item_content_body_text\">" . $description . "</p></div></div></div>";
            $counter++;
        }
