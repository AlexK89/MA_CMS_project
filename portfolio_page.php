<?php
include ("./php_functions/portfolio_functions.php");
...
<head>
    ...
    <title>Edit Portfolio Page || CMS</title>
</head>
<body>
...
<aside class="sidebar">
    <nav class= "navigation_bar">
        <ul class="tab_list">
            ...
            <li class="selected_tab"><a href="portfolio_page.php">Edit Portfolio page</a></li>
            <li class="tab portfolio_page"><a href="./Portfolio_project-2.0/portfolio.php">Go to Portfolio page</a></li>
        </ul>
    </nav>
</aside>
<div class="content">
    <div class="container">
        ...
        <form action="php_functions/portfolio_functions.php" method="POST" enctype="multipart/form-data" class="main_form">
            ...
            <div class="form_block">
                <input type="text" name="project_url" id="project_url" placeholder="Project url" class="input_area label">
            </div>
            <div class="form_block">
        ...
        foreach ($data as $item) {
            ...
            $block_structure .= "<p class=\"item_content_body_text\">" . $description . "</p>";
            $block_structure .= "<p class=\"item_content_body_text\">URL: <a href=\"http://" . $project_url ."\">" . $project_url . "</a></p>" . "</div></div></div>";
            $counter++;
        }
